...
!function(e,t){"use strict";var n=e.navigator.userAgent.toLowerCase();if(/trident/gi.test(n)||/msie/gi.test(n)){for(var o,r=t.querySelectorAll("use"),i=0;i<r.length;i++)o="#"+(o=r[i].getAttribute("xlink:href")).split("#")[1],r[i].setAttribute("xlink:href",o);if(!t.createElementNS||!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var a,l,s="localStorage"in e&&null!==e.localStorage,c=function(){t.body.insertAdjacentHTML("afterbegin",l)},g=function(){t.body?c():t.addEventListener("DOMContentLoaded",c)};if(s&&2==localStorage.getItem("inlineSVGrev")&&(l=localStorage.getItem("inlineSVGdata")))return g();try{(a=new XMLHttpRequest).open("GET","img/svg/symbol/sprite.svg",!0),a.onload=function(){200<=a.status&&a.status<400&&(l=a.responseText,g(),s&&(localStorage.setItem("inlineSVGdata",l),localStorage.setItem("inlineSVGrev",2)))},a.send()}catch(e){}}}(window,document),window.onload=function(){};
$(document).ready(function(){document.createElement("picture");var o=window.navigator.userAgent.toLowerCase();if(/trident/gi.test(o)||/msie/gi.test(o)){$("symbol").parent().attr("style","display: none;");var s=!1,n=$(".social__link");n.on("mousedown",function(){$(this).css({"background-color":"#D7373B","box-shadow":"inset 0 3px 0 0 #c13135"}),$(this).children().css("opacity",.3),s=!0}),n.on("mouseout",function(){$(this).css({"background-color":"#e1e1e1","box-shadow":"none"}),s&&($(this).children().css("opacity",1),s=!1)}),n.on("mousemove",function(){s||$(this).css({"background-color":"#E74246","box-shadow":"none"})});var t=$(".works__link"),i=!1;t.on("mousemove",function(){i||$(this).css("opacity",1)}),t.on("mousedown",function(){i=!0,$(this).css("opacity",.1)}),t.on("mouseout",function(){i=!1,$(this).css("opacity",.3)});var c=$(".logo[href]");c.on("mousedown",function(){!0,$(this).css("opacity",.3)}),c.on("mouseout",function(){!1,$(this).css("opacity",1)})}});
$(document).ready(function(){$(".main-slider").slick({dots:!0,arrows:!1,infinite:!0,speed:300,slidesToShow:1,adaptiveHeight:!0});var o=new Popup({popup:".modal__popup",closeModal:".modal__popup-close",overlay:".modal__overlay"});$(".address__button").on("click",function(){o.open($(".modal__write"))}),$(".option").removeClass("product__option--nojs"),$(".product").hover(function(){$(this).children(".option").slideDown()},function(){$(this).children(".option").slideUp()})});